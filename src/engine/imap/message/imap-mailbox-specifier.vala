...
public class Geary.Imap.MailboxSpecifier : BaseObject, Gee.Hashable<MailboxSpecifier>, Gee.Comparable<MailboxSpecifier> {
     ...
     *
     * For sanity reasons, the Geary engine uses NORMALIZED_INBOX_NAME as the "canonical" IMAP
     * Inbox name.  This verifies that the string is truely canonical, i.e. a case-sensitive
     * comparison is made.
     *
     * See [[http://tools.ietf.org/html/rfc3501#section-5.1]]
     *
